...
<body class="hold-transition login-page">
   <div class="login-box">
      <div class="login-logo">
         <img src="<?php echo base_url()?>assets/img/template/logo-cbt.png" class="img-responsive" style="padding: 10px 50px;">
      </div>
      <div class="login-box-body" style="">
         <div class="login">
            ...
            <div class="alert alert-success alert-dismissable">
               ...
               <strong>Tu sesión ha sido cerrada correctamente.</strong><br/>
            </div>
